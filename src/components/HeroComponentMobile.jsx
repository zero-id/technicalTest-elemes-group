            ...
            <div className="hero-image-mobile mt-5 pt-4 position-relative">
              ...
              <div className="mt-5 pt-5">
                ...
                <div className="d-flex gap-3">
                  <a href="#" className="border-0 align-self-center text-decoration-none px-3 py-2 rounded-4 main-color-bg text-white shadow main-color-bg text-white">Daftar Sekarng</a>
                  <a href="#" className="border-0 align-self-center text-decoration-none px-3 py-2 rounded-4 main-color-bg text-dark shadow bg-light ">About Us</a>
                </div>
              </div>
            </div>
          </div>
